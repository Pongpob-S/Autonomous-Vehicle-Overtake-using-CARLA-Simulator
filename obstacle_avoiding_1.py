...
try:
	...
	spawn_point2 = carla.Transform(carla.Location(-300.0, 37, 1),carla.Rotation(0,0,0))
	obstacle2 = world.spawn_actor(bp2, spawn_point2)
	actor_list.append(obstacle2)
	obstacle2.apply_control(carla.VehicleControl(brake = 1.0))
	...
	spawn_point3 = carla.Transform(carla.Location(-270, 33.5, 2),carla.Rotation(0,0,0))
	obstacle3 = world.spawn_actor(bp3, spawn_point3)
	actor_list.append(obstacle3)
	obstacle3.apply_control(carla.VehicleControl(brake = 1.0))
...
#
	...
	while not GameDone:
		...
		#cv2.imshow("right_lane rgb", right_warped)
		cv2.imshow("right_lane hls", bin_warped_right)
